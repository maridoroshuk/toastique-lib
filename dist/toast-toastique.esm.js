...
import React__default, { useEffect, useLayoutEffect, useState, useRef, forwardRef, useCallback, useContext, useMemo, useDebugValue, createElement } from 'react';
...
function Toast(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Container$1, {
    ...
    src: icon
  }), /*#__PURE__*/React__default.createElement(Body, null, /*#__PURE__*/React__default.createElement(Heading, null, heading), /*#__PURE__*/React__default.createElement(Content, null, content)), /*#__PURE__*/React__default.createElement(Close, {
    onClick: handleOnCloseToastClick
  }, /*#__PURE__*/React__default.createElement(CloseImg, {
    src: img$4,
    alt: "close"
  })));
}
...
var useToastPortal = function useToastPortal(position) {
  ...
  var _useState3 = useState("toast-portal-".concat(v4())),
...
function ToastList(_ref) {
  ...
  return loaded ? /*#__PURE__*/createPortal( /*#__PURE__*/React__default.createElement(Container, null, toasts.map(function (t) {
...
var ToastList$1 = /*#__PURE__*/React__default.memo(ToastList);

export { ToastList$1 as ToastList, toast };
//# sourceMappingURL=toast-toastique.esm.js.map
